...
class Usuarios extends \AppBundle\Entity\Usuarios implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Usuarios' . "\0" . 'usuario', '' . "\0" . 'AppBundle\\Entity\\Usuarios' . "\0" . 'password', '' . "\0" . 'AppBundle\\Entity\\Usuarios' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Usuarios' . "\0" . 'saldo', '' . "\0" . 'AppBundle\\Entity\\Usuarios' . "\0" . 'id'];
        }
