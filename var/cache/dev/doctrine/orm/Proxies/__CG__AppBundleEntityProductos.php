...
class Productos extends \AppBundle\Entity\Productos implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Productos' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Productos' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\Productos' . "\0" . 'precio', '' . "\0" . 'AppBundle\\Entity\\Productos' . "\0" . 'img', '' . "\0" . 'AppBundle\\Entity\\Productos' . "\0" . 'id'];
        }
