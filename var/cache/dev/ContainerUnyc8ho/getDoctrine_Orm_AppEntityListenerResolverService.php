...
// Returns the private 'doctrine.orm.app_entity_listener_resolver' shared service.
...
return $this->services['doctrine.orm.app_entity_listener_resolver'] = new \Doctrine\Bundle\DoctrineBundle\Mapping\ContainerAwareEntityListenerResolver($this);
